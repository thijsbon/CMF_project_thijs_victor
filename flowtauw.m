%% FLOWTAUW
% for prescribed flow rate and wall shear stress
% only difference from flowvgrad: calculate dudzwall with prescribed wall shear stress;
Qdif = 1;
       ...
       count = 0;
        while max(abs(Qdif)) > 0.000001;
            ...
            %only difference from flowvgrad: calculate dudzwall with
            %prescribed wall shear stress;
            dudzwall = tauw./mu(end);
            %
